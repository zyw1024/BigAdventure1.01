...
class Settings:
    ...
    def __init__(self):
        ...
        self.bgm.append("materials/sounds/bgm/00000004090F Main Menu主题2.ogg")
        ...
        # Hurt sound
        self.player_minor_wound_sound = []
        self.player_minor_wound_sound.append(pygame.mixer.Sound("materials/sounds/hurt/玩家轻伤1.wav"))
        self.player_minor_wound_sound.append(pygame.mixer.Sound("materials/sounds/hurt/玩家轻伤2.wav"))
        self.player_middle_wound_sound = []
        self.player_middle_wound_sound.append(pygame.mixer.Sound("materials/sounds/hurt/玩家中等伤1.wav"))
        self.player_middle_wound_sound.append(pygame.mixer.Sound("materials/sounds/hurt/玩家中等伤2.wav"))
        self.player_severe_wound_sound = []
        self.player_severe_wound_sound.append(pygame.mixer.Sound("materials/sounds/hurt/玩家重伤.wav"))
        ...
        self.skeleton_soldier_speed_factor = 1.4
        self.unicorn_speed_factor = 1.3
        self.blue_dragon_speed_factor = 1
        self.black_dragon_speed_factor = 1
        # Bullet's speed
        ...
        self.skull_bullet_multiple = 2
        self.coin_bullet_multiple = 1.5

        # Attack consumption
        self.player_normal_attack_energy_consumption = 1
        self.player_coin_attack_coin_consumption = 1
        self.player_skull_attack_health_consumption = 20
        ...
        # Treasures' abilities
        self.ruby_raw_health_supply = 200
        self.ruby_round_health_supply = 400
        self.ruby_dragon_health_supply = 600
        ...
        self.orig_skeleton_soldier_left.update(
            {0: pygame.image.load("materials/images/monsters/skeleton_soldier/skeleton_soldier_left0.png")})
        self.orig_skeleton_soldier_left.update(
            {1: pygame.image.load("materials/images/monsters/skeleton_soldier/skeleton_soldier_left1.png")})
        self.orig_skeleton_soldier_left.update(
            {2: pygame.image.load("materials/images/monsters/skeleton_soldier/skeleton_soldier_left2.png")})
        self.orig_skeleton_soldier_left.update(
            {3: pygame.image.load("materials/images/monsters/skeleton_soldier/skeleton_soldier_left3.png")})
        self.orig_skeleton_soldier_left.update(
            {4: pygame.image.load("materials/images/monsters/skeleton_soldie_slash/skeleton_soldier_left_slash0.png")})
        self.orig_skeleton_soldier_left.update(
            {5: pygame.image.load("materials/images/monsters/skeleton_soldie_slash/skeleton_soldier_left_slash1.png")})
        self.orig_skeleton_soldier_right = {}
        self.orig_skeleton_soldier_right.update(
            {0: pygame.image.load("materials/images/monsters/skeleton_soldier/skeleton_soldier_right0.png")})
        self.orig_skeleton_soldier_right.update(
            {1: pygame.image.load("materials/images/monsters/skeleton_soldier/skeleton_soldier_right1.png")})
        self.orig_skeleton_soldier_right.update(
            {2: pygame.image.load("materials/images/monsters/skeleton_soldier/skeleton_soldier_right2.png")})
        self.orig_skeleton_soldier_right.update(
            {3: pygame.image.load("materials/images/monsters/skeleton_soldier/skeleton_soldier_right3.png")})
        self.orig_skeleton_soldier_right.update(
            {4: pygame.image.load("materials/images/monsters/skeleton_soldie_slash/skeleton_soldier_right_slash0.png")})
        self.orig_skeleton_soldier_right.update(
            {5: pygame.image.load("materials/images/monsters/skeleton_soldie_slash/skeleton_soldier_right_slash1.png")})
        ...
        self.orig_blue_dragon_left.update(
            {0: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_left0.png")})
        self.orig_blue_dragon_left.update(
            {1: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_left1.png")})
        self.orig_blue_dragon_left.update(
            {2: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_left2.png")})
        self.orig_blue_dragon_left.update(
            {3: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_left3.png")})
        self.orig_blue_dragon_left.update(
            {4: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_left4.png")})
        self.orig_blue_dragon_left.update(
            {5: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_left5.png")})
        self.orig_blue_dragon_right = {}
        self.orig_blue_dragon_right.update(
            {0: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_right0.png")})
        self.orig_blue_dragon_right.update(
            {1: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_right1.png")})
        self.orig_blue_dragon_right.update(
            {2: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_right2.png")})
        self.orig_blue_dragon_right.update(
            {3: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_right3.png")})
        self.orig_blue_dragon_right.update(
            {4: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_right4.png")})
        self.orig_blue_dragon_right.update(
            {5: pygame.image.load("materials/images/monsters/blue_dragon/blue_dragon_right5.png")})

        # Black dragon original image
        self.orig_black_dragon_left = {}
        self.orig_black_dragon_left.update(
            {0: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_left0.png")})
        self.orig_black_dragon_left.update(
            {1: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_left1.png")})
        self.orig_black_dragon_left.update(
            {2: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_left2.png")})
        self.orig_black_dragon_left.update(
            {3: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_left3.png")})
        self.orig_black_dragon_left.update(
            {4: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_left4.png")})
        self.orig_black_dragon_left.update(
            {5: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_left5.png")})
        self.orig_black_dragon_right = {}
        self.orig_black_dragon_right.update(
            {0: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_right0.png")})
        self.orig_black_dragon_right.update(
            {1: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_right1.png")})
        self.orig_black_dragon_right.update(
            {2: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_right2.png")})
        self.orig_black_dragon_right.update(
            {3: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_right3.png")})
        self.orig_black_dragon_right.update(
            {4: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_right4.png")})
        self.orig_black_dragon_right.update(
            {5: pygame.image.load("materials/images/monsters/black_dragon/black_dragon_right5.png")})
        ...
        self.orig_black_fireball = pygame.image.load(
            "materials/images/bullets/boss_skills/black_fireball/black_fireball.png")
        self.orig_ground_needles = {}
        self.orig_ground_needles.update(
            {0: pygame.image.load("materials/images/bullets/boss_skills/ground_needle/ground_needle0.png")})
        self.orig_ground_needles.update(
            {1: pygame.image.load("materials/images/bullets/boss_skills/ground_needle/ground_needle1.png")})
        self.orig_ground_needles.update(
            {2: pygame.image.load("materials/images/bullets/boss_skills/ground_needle/ground_needle2.png")})
        self.orig_ground_needles.update(
            {3: pygame.image.load("materials/images/bullets/boss_skills/ground_needle/ground_needle3.png")})
        self.orig_ground_needles.update(
            {4: pygame.image.load("materials/images/bullets/boss_skills/ground_needle/ground_needle4.png")})
        self.orig_ground_needles.update(
            {5: pygame.image.load("materials/images/bullets/boss_skills/ground_needle/ground_needle5.png")})
    ...
    def loadnewsettings(self):
        ...
        # Monsters' ATK update
        self.skeleton_soldier_atk += 10
        self.unicorn_atk += 20
        self.blue_dragon_atk += 30
        self.black_dragon_atk += 50

        #Monsters' health update
        self.skeleton_soldier_health += 20
        self.unicorn_health += 30
        self.blue_dragon_health += 50
        self.black_dragon_health += 100
        ...
        for k, v in self.orig_wall_stone.items():
            self.wall_stone.update(
                {k: pygame.transform.scale(v, (int(self.maze_block_width), int(self.maze_block_height)))})

        # Update road image size
        for k, v in self.orig_road_stone.items():
            self.road_stone.update(
                {k: pygame.transform.scale(v, (int(self.maze_block_width), int(self.maze_block_height)))})
        ...
        for k, v in self.orig_skeleton_soldier_left.items():
            self.skeleton_soldier_left.update(
                {k: pygame.transform.scale(v, (int(self.skeleton_soldier_width), int(self.skeleton_soldier_height)))})
        for k, v in self.orig_skeleton_soldier_right.items():
            self.skeleton_soldier_right.update(
                {k: pygame.transform.scale(v, (int(self.skeleton_soldier_width), int(self.skeleton_soldier_height)))})
        for k, v in self.orig_boom.items():
            self.skeleton_soldier_boom.update(
                {k: pygame.transform.scale(v, (int(self.skeleton_soldier_width), int(self.skeleton_soldier_height)))})

        # Update unicorn image size
        for k, v in self.orig_unicorn_left.items():
            self.unicorn_left.update(
                {k: pygame.transform.scale(v, (int(self.unicorn_width), int(self.unicorn_height)))})
        for k, v in self.orig_unicorn_right.items():
            self.unicorn_right.update(
                {k: pygame.transform.scale(v, (int(self.unicorn_width), int(self.unicorn_height)))})
        for k, v in self.orig_boom.items():
            self.unicorn_boom.update(
                {k: pygame.transform.scale(v, (int(self.unicorn_width), int(self.unicorn_height)))})

        # Update blue dragon image size
        for k, v in self.orig_blue_dragon_left.items():
            self.blue_dragon_left.update(
                {k: pygame.transform.scale(v, (int(self.blue_dragon_width), int(self.blue_dragon_height)))})
        for k, v in self.orig_blue_dragon_right.items():
            self.blue_dragon_right.update(
                {k: pygame.transform.scale(v, (int(self.blue_dragon_width), int(self.blue_dragon_height)))})
        for k, v in self.orig_boom.items():
            self.blue_dragon_boom.update(
                {k: pygame.transform.scale(v, (int(self.blue_dragon_width), int(self.blue_dragon_height)))})

        # Update black dragon image size
        for k, v in self.orig_black_dragon_left.items():
            self.black_dragon_left.update(
                {k: pygame.transform.scale(v, (int(self.black_dragon_width), int(self.black_dragon_height)))})
        for k, v in self.orig_black_dragon_right.items():
            self.black_dragon_right.update(
                {k: pygame.transform.scale(v, (int(self.black_dragon_width), int(self.black_dragon_height)))})
        for k, v in self.orig_boom.items():
            self.black_dragon_boom.update(
                {k: pygame.transform.scale(v, (int(self.black_dragon_width), int(self.black_dragon_height)))})

        # Update Non_Player_Character images size
        for k, v in self.orig_fortune_cat_img.items():
            self.fortune_cat_img.update(
                {k: pygame.transform.scale(v, (int(self.fortune_cat_width), int(self.fortune_cat_height)))})
        ...
        for k, v in self.orig_little_girl_img.items():
            self.little_girl_img.update(
                {k: pygame.transform.scale(v, (int(self.little_girl_width), int(self.little_girl_height)))})

        # Update bullets' image size
        self.bluebullet_img = pygame.transform.scale(self.orig_bluebullet,
                                                     (int(self.bluebullet_width), int(self.bluebullet_height)))
        self.coin_bullet_img = pygame.transform.scale(self.orig_coin_bullet,
                                                      (int(self.coin_bullet_width), int(self.coin_bullet_height)))
        self.skull_bullet_img = pygame.transform.scale(self.orig_skull_bullet,
                                                       (int(self.skull_bullet_width), int(self.skull_bullet_height)))
        self.redbullet_img = pygame.transform.scale(self.orig_redbullet,
                                                    (int(self.redbullet_width), int(self.redbullet_height)))
        self.fireball_img = pygame.transform.scale(self.orig_fireball,
                                                   (int(self.fireball_width), int(self.fireball_height)))
        self.lightning_ball_img = pygame.transform.scale(self.orig_lightning_ball, (
            int(self.lightning_ball_width), int(self.lightning_ball_height)))
        self.black_fireball_img = pygame.transform.scale(self.orig_black_fireball, (
            int(self.black_fireball_width), int(self.black_fireball_height)))

        for k, v in self.orig_ground_needles.items():
            self.ground_needles.update(
                {k: pygame.transform.scale(v, (int(self.ground_needle_width), int(self.ground_needle_height)))})

        # Update start's amd end point's image
        self.start_img = pygame.transform.scale(self.orig_start_img,
                                                (int(self.maze_block_width), int(self.maze_block_height)))
        self.end_img = pygame.transform.scale(self.orig_end_img,
                                              (int(self.maze_block_width), int(self.maze_block_height)))

        # Update treassures' image size
        self.ruby_raw_img = pygame.transform.scale(self.orig_ruby_raw,
                                                   (int(self.ruby_raw_width), int(self.ruby_raw_height)))
        self.ruby_round_img = pygame.transform.scale(self.orig_ruby_round,
                                                     (int(self.ruby_round_width), int(self.ruby_round_height)))
        self.ruby_dragon_img = pygame.transform.scale(self.orig_ruby_dragon,
                                                      (int(self.ruby_dragon_width), int(self.ruby_dragon_height)))
        self.sapphire_raw_img = pygame.transform.scale(self.orig_sapphire_raw,
                                                       (int(self.sapphire_raw_width), int(self.sapphire_raw_height)))
        self.sapphire_round_img = pygame.transform.scale(self.orig_sapphire_round, (
            int(self.sapphire_round_width), int(self.sapphire_round_height)))
        self.sapphire_dragon_img = pygame.transform.scale(self.orig_sapphire_dragon, (
            int(self.sapphire_dragon_width), int(self.sapphire_dragon_height)))

        # Update coins image size
        self.some_coins_img = pygame.transform.scale(self.orig_some_coins,
                                                     (int(self.some_coins_width), int(self.some_coins_height)))
        self.lots_of_coins_img = pygame.transform.scale(self.orig_lots_of_coins,
                                                        (int(self.lots_of_coins_width), int(self.lots_of_coins_height)))
        self.massive_coins_img = pygame.transform.scale(self.orig_massive_coins,
                                                        (int(self.massive_coins_width), int(self.massive_coins_height)))
